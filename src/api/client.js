...
export const api = {
  ...
  promoVideos: () => apiFetch("/public/promo-videos/"),
  packs: () => apiFetch("/public/packs/"),
  packCheckout: (packId) => apiFetch(`/packs/${packId}/checkout/`, { method: "POST" }),
  chatTutoringPlans: () => apiFetch("/public/chat-tutoring-plans/"),
  chatTutoringCheckout: (planId) => apiFetch(`/chat-tutoring-plans/${planId}/checkout/`, { method: "POST" }),
  chatTutoringTryFree: (planId) => apiFetch(`/chat-tutoring-plans/${planId}/try-free/`, { method: "POST" }),
  myChatSubscriptions: () => apiFetch("/me/chat-subscriptions/"),
  myTeacherChatSubscriptions: () => apiFetch("/me/teacher-chat-subscriptions/"),
  chatThreadMessages: (subscriptionId) => apiFetch(`/chat-subscriptions/${subscriptionId}/messages/`),
  sendChatMessage: (subscriptionId, formData) =>
    apiFetch(`/chat-subscriptions/${subscriptionId}/messages/`, { method: "POST", body: formData }),
  ...
  getMyWhiteboard: () => apiFetch("/me/whiteboard/"),
  mySelfStudyPlans: () => apiFetch("/me/selfstudy-plans/"),
  mySelfStudyContent: () => apiFetch("/me/selfstudy-content/"),
  submitSelfStudyContent: (formData) => apiFetch("/me/selfstudy-content/", { method: "POST", body: formData }),
  saveMyWhiteboard: (pages) => apiFetch("/me/whiteboard/", { method: "PUT", body: { pages } }),
